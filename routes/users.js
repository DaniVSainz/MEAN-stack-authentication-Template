...
// Old implementation of register route incase something ever goes wrong.
...
//       if(user){
//         res.status(400).send({success: false, msg: `An Account with email:  ${newUser.email} already exists`});
//       }else{
...
router.post('/authenticate', (req, res, next) => {
  ...
  User.getUserByUsername(username, (err, user) => {
    ...
    if(user.isVerified == false){
      return res.json({success: false, msg: `Email is not verified, please verify to log in.`})
    }
